...
html = """
        <div id="readme" class="center-block">
          ...
          <p>
            ...
            with markers. Each marker represents the location of a met mast.
...
for key in keys:
    if 'daily' in key:
        ...
        <p><a href="https://github.com/kikocorreoso/datos_aemet/blob/master/README.md" target="_blank">link</a><p>
        """
